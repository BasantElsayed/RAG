...
:root {
    ...
    --card-hover: rgba(234,242,252,0.95);
...
.logo-icon {
    ...
    box-shadow:
        0 8px 30px rgba(21,101,192,0.16);
}
...
.status-dot {
    ...
    box-shadow:
        0 0 0 5px rgba(21,101,192,0.06),
        0 0 15px rgba(21,101,192,0.55);
...
@keyframes orbGlow {
    ...
    50% {
        box-shadow: 0 0 18px rgba(21,101,192,0.28);
    }
}
